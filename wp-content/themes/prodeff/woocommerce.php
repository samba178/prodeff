			...
			<div class="row">
				...
				<div class="<?php echo esc_attr($main_class) ?>" role="main" itemprop="mainContentOfPage">
					<div class="main-content">
						...
						<div class="woo-content" data-msgtext="<?php esc_attr_e('Loading products','luxury-wp')?>" data-finishedmsg="<?php esc_attr_e('All products loaded','luxury-wp')?>" data-contentselector=".woo-content .shop-loop > ul.products"  data-paginate="<?php echo esc_attr($woo_products_pagination) ?>"  data-itemselector=".woo-content li.product">
						<?php }?>
						<?php 
						if(class_exists('DH_Woocommerce'))
