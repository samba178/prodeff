<?php
/*
Template Name: Popular Projects
*/
?>
<?php 
...
?>
<?php get_header() ?>
<?php query_posts('post_type=projects&post_status=publish&orderby=post_views&order=desc&posts_per_page=10&paged='. get_query_var('paged')); ?>



<div id="main" class="content-container archive-projects archive-popular-projects">
											...
											<div class="entry-info<?php if(!empty($hide_thumbnail)):?> entry-hide-thumbnail<?php endif;?>">
												...
												<?php if($layout != 'list' && $layout != 'grid'): ?>
													<div class="entry-meta icon-meta">
														<?php 
                                                        echo '<span class="meta-author meta-views">'.do_shortcode('[post-views]'). '</span>';
