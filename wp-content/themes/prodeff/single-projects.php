...
?>
<?php get_header() ?>
	<div class="content-container single-projects">
							...
							<div class="hentry-wrap">
								...
								<div class="entry-info">
									...
									<div class="entry-content" itemprop="articleBody">
										<?php the_content( esc_html__( 'Continue reading &hellip;', 'luxury-wp' ) ) ?>
										<?php wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'luxury-wp' ), 'after' => '</div>' ) ); ?>
									</div>
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="entry-tags">
													<span><?php esc_html_e( 'Tags:', 'luxury-wp' );?></span>
													<?php the_tags('',', ')?>
												</div>
												<?php endif;?>
											</div>
											<div class="col-sm-6">
												<?php if(dh_get_theme_option('show-post-share',1)) dh_share(__('Share:','luxury-wp'),dh_get_theme_option('post-fb-share',1),dh_get_theme_option('post-tw-share',1),dh_get_theme_option('post-go-share',1),dh_get_theme_option('post-pi-share',0),dh_get_theme_option('post-li-share',1));?>
											</div>
										</div>
									</div>
								</div>
