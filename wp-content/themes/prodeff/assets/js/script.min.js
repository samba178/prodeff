...
});}) ,a(document).ready(function(){DH.initScrollspy()}),a(window).on("load",function(){DH.init()}),DH.woocommerce_variations_form_init(),a(document).bind("dh-change-layout",function(){a("#newsletterModal").remove(),setTimeout(function(){DH.init() },500)} )}(jQuery);
>>>>>>> f68fd62238210390f27a496cda9721686ae60dc2
