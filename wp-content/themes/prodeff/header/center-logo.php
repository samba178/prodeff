...
?>
<header id="header" class="header-container page-heading-<?php echo esc_attr($page_heading) ?> header-type-center-logo header-navbar-center-logo<?php if($menu_transparent):?> header-absolute header-transparent<?php endif?> header-scroll-resize" itemscope="itemscope" itemtype="<?php echo dh_get_protocol()?>://schema.org/Organization" role="banner">
							...
							<div class="col-md-12 navbar-default-col">
								<div class="navbar-wrap">
									<div class="header-left">
										...
										<?php
											$nav_left = dh_get_theme_option('center-logo-nav-left') ;
											if(!empty($nav_left)):
												wp_nav_menu( array(
									...
									<div class="header-right">
										<nav class="collapse navbar-collapse primary-navbar-collapse" itemtype="<?php echo dh_get_protocol() ?>://schema.org/SiteNavigationElement" itemscope="itemscope" role="navigation">
										<?php
											$nav_right = dh_get_theme_option('center-logo-nav-right') ;
											if(!empty($nav_right)):
												wp_nav_menu( array(
													'theme_location'    => 'primary',
													'container'         => false,
