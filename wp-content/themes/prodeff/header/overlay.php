...
<header id="header" class="header-container header-type-toggle-offcanvas header-navbar-toggle-offcanvas header-logo-position-<?php echo dh_get_theme_option('logo-position','center') ?>" itemscope="itemscope" itemtype="<?php echo dh_get_protocol()?>://schema.org/Organization" role="banner">
