...
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Days','luxury-wp').'</div>
	<div class="countdown-item-value">%D</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Hours','luxury-wp').'</div>
	<div class="countdown-item-value">%H</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Minutes','luxury-wp').'</div>
	<div class="countdown-item-value">%M</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Seconds','luxury-wp').'</div>
