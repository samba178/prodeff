...
if (dhwc_is_active() && !class_exists('DHWCLookbook')){
	class DHWCLookbook {
		...
		public function register_taxonomy(){
			...
			$product_lookbok_slug = empty( $permalinks['lookbok_base'] ) ? _x( 'product-lookbok', 'slug', 'luxury-wp' ) : $permalinks['lookbok_base'];
			...
			register_taxonomy ( 'product_lookbook', 
				...
				apply_filters ( 'dhwc_taxonomy_args_product_lookbok', array (
					...
					'label' => __ ( 'Product Lookbooks', 'luxury-wp' ),
					'labels' => array (
							'name' => __ ( 'Product Lookbooks', 'luxury-wp' ),
							'singular_name' => __ ( 'Product Lookbook', 'luxury-wp' ),
							'menu_name' => _x ( 'Lookbooks', 'Admin menu name', 'luxury-wp' ),
							'search_items' => __ ( 'Search Product Lookbooks', 'luxury-wp' ),
							'all_items' => __ ( 'All Product Lookbooks', 'luxury-wp' ),
							'parent_item' => __ ( 'Parent Product Lookbook', 'luxury-wp' ),
							'parent_item_colon' => __ ( 'Parent Product Lookbook:', 'luxury-wp' ),
							'edit_item' => __ ( 'Edit Product Lookbook', 'luxury-wp' ),
							'update_item' => __ ( 'Update Product Lookbook', 'luxury-wp' ),
							'add_new_item' => __ ( 'Add New Product Lookbook', 'luxury-wp' ),
							'new_item_name' => __ ( 'New Product Lookbook Name', 'luxury-wp' ) 
					),
					'show_ui' => true,
