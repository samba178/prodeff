...
if (dhwc_is_active() && !class_exists('DHWC_Brand')){
	class DHWC_Brand {
		...
		function dhwc_init_taxonomy(){
			...
			$product_brand_slug = empty( $permalinks['brand_base'] ) ? _x( 'product-brand', 'slug', 'luxury-wp' ) : $permalinks['brand_base'];
			...
			register_taxonomy ( 'product_brand', 
				...
				apply_filters ( 'dhwc_taxonomy_args_product_brand', array (
					...
					'label' => __ ( 'Product Brands', 'luxury-wp' ),
					'labels' => array (
							'name' => __ ( 'Product Brands', 'luxury-wp' ),
							'singular_name' => __ ( 'Product Brand', 'luxury-wp' ),
							'menu_name' => _x ( 'Brands', 'Admin menu name', 'luxury-wp' ),
							'search_items' => __ ( 'Search Product Brands', 'luxury-wp' ),
							'all_items' => __ ( 'All Product Brands', 'luxury-wp' ),
							'parent_item' => __ ( 'Parent Product Brand', 'luxury-wp' ),
							'parent_item_colon' => __ ( 'Parent Product Brand:', 'luxury-wp' ),
							'edit_item' => __ ( 'Edit Product Brand', 'luxury-wp' ),
							'update_item' => __ ( 'Update Product Brand', 'luxury-wp' ),
							'add_new_item' => __ ( 'Add New Product Brand', 'luxury-wp' ),
							'new_item_name' => __ ( 'New Product Brand Name', 'luxury-wp' ) 
					),
					'show_ui' => true,
		...
		*/
	    ...
	    function dhwc_add_product_brand_meta(){
			...
			if ( is_singular( 'product' ) ) {
				echo apply_filters('dhwc_product_brand_meta',dhwc_get_brands( $post->ID, ', ', ' <span class="posted_in">' . __('Brand:', 'luxury-wp').' ', '.</span>' ));
			}
	    }
