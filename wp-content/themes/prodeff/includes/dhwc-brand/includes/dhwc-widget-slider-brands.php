...
class DHWC_Widget_Brand_Slider extends WP_Widget {
	...
	public function __construct(){
		$widget_options = array( 'classname' => 'dhwc_widget_brand_slider', 'description' => __( 'Shows product brans with slider','luxury-wp') );
		$control_options = array();
		parent::__construct('dhwc_widget_brand_slider',__('DHWOO Product Brand Slider','luxury-wp'), $widget_options, $control_options);
	...
	public function widget($args, $instance){
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'Brands', 'luxury-wp' ) : $instance['title'], $instance, $this->id_base);
	...
	public function form($instance){
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'luxury-wp') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e( 'Order by:', 'luxury-wp' ) ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('hide_empty'); ?>"><?php _e( 'Hide empty brands', 'luxury-wp' ); ?></label>
		</p>
		<?php
	}
}