		...
		if($depth  == 0){
			...
			<p class="field-megamenu-status description description-wide">
				<label for="edit-menu-item-megamenu-status-<?php echo esc_attr($item_id); ?>">
					...
					<strong><?php _e( 'Enable Mega Menu', 'luxury-wp' ); ?></strong>
				</label>
			</p>
			<p class="field-megamenu field-megamenu-fullwidth description description-wide">
				<label for="edit-menu-item-megamenu-fullwidth-<?php echo esc_attr($item->ID); ?>">
					...
					<?php _e( 'Full Width Mega Menu', 'luxury-wp' ); ?>
				</label>
			</p>
			<p class="field-megamenu field-megamenu-columns description description-wide">
				<label for="edit-menu-item-megamenu-columns-<?php echo esc_attr($item_id); ?>">
					<?php _e( 'Mega Menu Columns', 'luxury-wp' ); ?>
			...
			<p class="field-menu-badge description description-wide">
				<label for="edit-menu-item-badge-<?php echo esc_attr($item_id); ?>">
					...
					echo '<button type="button" class="button button-primary"  id="edit-menu-item-'.$item_id.'-badge-upload" >' . __( 'Select Image', 'luxury-wp' ) . '</button> ';
					echo '<button type="button" class="button" id="edit-menu-item-'.$item_id.'-badge-clear">' . __( 'Clear Image', 'luxury-wp' ) . '</button>';
			...
			<p class="field-megamenu-title description description-wide">
				<label for="edit-menu-item-megamenu-title-<?php echo esc_attr($item_id); ?>">
					...
					<strong><?php _e( 'Disable Mega Menu Column Title', 'luxury-wp' ); ?></strong>
				</label>
			</p>
			<p class="field-megamenu-sidebar description description-wide">
				<label for="edit-menu-item-megamenu-widgetarea-<?php echo esc_attr($item_id); ?>">
					<?php _e( 'Display Sidebar in Menu', 'luxury-wp' ); ?>
					<select id="edit-menu-item-megamenu-sidebar-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-megamenu-sidebar" name="dh-megamenu-sidebar[<?php echo esc_attr($item_id); ?>]">
						<option value="0"><?php _e( 'Select Widget Area...', 'luxury-wp' ); ?></option>
						<?php
			...
			<p class="field-megamenu-sidebar description description-wide">
				<label for="edit-menu-item-megamenu-widgetarea-<?php echo esc_attr($item_id); ?>">
					<?php _e( 'Display Sidebar in Menu', 'luxury-wp' ); ?>
					<select id="edit-menu-item-megamenu-sidebar-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-megamenu-sidebar" name="dh-megamenu-sidebar[<?php echo esc_attr($item_id); ?>]">
						<option value=""><?php _e( 'Select Widget Area', 'luxury-wp' ); ?></option>
						<?php
						if( ! empty( $wp_registered_sidebars ) && is_array( $wp_registered_sidebars ) ):
						foreach( $wp_registered_sidebars as $sidebar ):
						?>
		...
		?>
			<p class="field-menu-icon description description-wide">
				<label for="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>">
					<?php _e( 'Menu Icon Class (Font Awesome Icon or Elegant Icon.ex: fa fa-home, elegant_icon_house_alt)', 'luxury-wp' ); ?>
			...
			<p class="field-menu-visibility description description-wide">
				<label for="edit-menu-item-visibility-<?php echo esc_attr($item_id); ?>">
					<?php _e( 'Visibility', 'luxury-wp' ); ?>
					<br/>
					<select id="edit-menu-item-menu-visibility-<?php echo esc_attr($item_id); ?>" name="dh-menu-visibility[<?php echo esc_attr($item_id); ?>]">
						<option value="" ><?php _e('All Devices', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility, 'hidden-phone' ) ?> value="hidden-phone"><?php _e('Hidden Phone', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility,'hidden-tablet' ) ?> value="hidden-tablet"><?php _e('Hidden Tablet', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility,'hidden-pc' ) ?> value="hidden-pc"><?php _e('Hidden PC', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility,'visible-phone' ) ?> value="visible-phone"><?php _e('Visible Phone', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility,'visible-tablet' ) ?> value="visible-tablet"><?php _e('Visible Tablet', 'luxury-wp'); ?></option>
						<option <?php selected( $item->dh_menu_visibility,'visible-pc' ) ?> value="visible-pc"><?php _e('Visible PC', 'luxury-wp'); ?></option>
					</select>
				</label>
			</p>
		<?php
