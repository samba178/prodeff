...
vc_map( 
	array( 
		'base' => 'dh_typed', 
		'name' => __( 'Animated typing', 'luxury-wp' ), 
		"description" => __( "Animated text typing", "sitesao" ), 
		...
		'params' => array( 
			...
			array( 
				...
				'heading' => __( 'Font Size (ex: 30px)', 'luxury-wp' ), 
				'type' => 'ui_slider', 
				'value' => '22px', 
				'data_min' => '0', 
				'data_max' => '50' ), 
			array( 
				'type' => 'colorpicker', 
				'heading' => __( 'Animated Text Color', 'luxury-wp' ), 
				'param_name' => 'typed_text_color', 
				'description' => __( 'Animated Text Color.', 'luxury-wp' ) ), 
			array( 
				'type' => 'colorpicker', 
				'heading' => __( 'Animated Text Background Color', 'luxury-wp' ), 
				'param_name' => 'typed_text_bg', 
				'description' => __( 'Animated Background Text Color.', 'luxury-wp' ) ), 
			array( 
				'type' => 'dropdown', 
				'heading' => __( 'Show more options', 'luxury-wp' ), 
				'param_name' => 'typed_show_options', 
				'std' => 'no', 
				'value' => array( __( 'Yes', 'luxury-wp' ) => 'yes', __( 'No', 'luxury-wp' ) => 'no' ), 
				'description' => __( 'Configure animation options.', 'luxury-wp' ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Character for cursor', 'luxury-wp' ), 
				'value' => '|', 
				'description' => __( 'Leave empty to remove the blinking cursor.', 'luxury-wp' ), 
				'param_name' => 'typed_options_cursorchar', 
				'dependency' => array( 'element' => 'typed_show_options', 'value' => array( 'yes' ) ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Iteration loop', 'luxury-wp' ), 
				'value' => '', 
				'description' => __( 'Leave empty for single loop only. Set -1 for infinite loop.', 'luxury-wp' ), 
				'param_name' => 'typed_options_loopcount', 
				'dependency' => array( 'element' => 'typed_show_options', 'value' => array( 'yes' ) ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Type speed', 'luxury-wp' ), 
				'value' => '10', 
				'description' => __( 'Type of speed when entering the text. (Unit is milliseconds)', 'luxury-wp' ), 
				'param_name' => 'typed_options_typespeed', 
				'dependency' => array( 'element' => 'typed_show_options', 'value' => array( 'yes' ) ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Back speed', 'luxury-wp' ), 
				'value' => '20', 
				'description' => __( 'Back speed when deleting the text. (Unit is milliseconds)', 'luxury-wp' ), 
				'param_name' => 'typed_options_backspeed', 
				'dependency' => array( 'element' => 'typed_show_options', 'value' => array( 'yes' ) ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Start delay', 'luxury-wp' ), 
				'value' => '0', 
				'description' => __( 'Set delay before starting text typing. (Unit is milliseconds)', 'luxury-wp' ), 
				'param_name' => 'typed_options_startdelay', 
				'dependency' => array( 'element' => 'typed_show_options', 'value' => array( 'yes' ) ) ), 
			array( 
				'type' => 'textfield', 
				'heading' => __( 'Back delay', 'luxury-wp' ), 
				'value' => '500', 
				'description' => __( 'Set back delay after text is typed. (Unit is milliseconds)', 'luxury-wp' ), 
