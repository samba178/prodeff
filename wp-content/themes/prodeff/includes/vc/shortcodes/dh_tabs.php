...
vc_map( 
	array( 
		...
		'name' => __( 'DH Tabs', 'luxury-wp' ), 
		'description' => __( 'Tabbed content', 'luxury-wp' ), 
		...
		'params' => array( 
			array( 
				...
				'description' => __( 'Tab Style.', 'luxury-wp' ) ), 
			array( 
		...
		'default_content' => '
					  [dh_tab title="' .
			 __( 'Item 1', 'luxury-wp' ) . '" tab_id="' . time() . '-1-' . rand( 0, 100 ) . '"][/dh_tab]
					  [dh_tab title="' .
			 __( 'Item 2', 'luxury-wp' ) . '" tab_id="' . time() . '-2-' . rand( 0, 100 ) . '"][/dh_tab]
					  [dh_tab title="' .
			 __( 'Item 3', 'luxury-wp' ) . '" tab_id="' . time() . '-3-' . rand( 0, 100 ) . '"][/dh_tab]
					  ' ) );
vc_map( 
	array( 
		'name' => __( 'DH Tab Content', 'luxury-wp' ), 
		'base' => 'dh_tab', 
		"category" => __( "Sitesao", 'luxury-wp' ), 
