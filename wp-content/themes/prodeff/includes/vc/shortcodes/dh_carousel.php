...
vc_map( 
	array( 
		...
		'name' => __( 'Carousel Content', 'luxury-wp' ), 
		'description' => __( 'Animated carousel with carousel', 'luxury-wp' ), 
		...
		'params' => array( 
			...
			array( 
				'param_name' => 'visible', 
				'heading' => __( 'The number of visible items', 'luxury-wp' ), 
				'type' => 'ui_slider', 
				'value' => '1', 
				'data_min' => '1', 
				'data_max' => '6' ), 
		...
		'default_content' => '
			 ...
			 '"][/dh_carousel_item]
					  [dh_carousel_item title="' .
			 __( 'Item 3', 'luxury-wp' ) . '" tab_id="' . time() . '-3-' . rand( 0, 100 ) . '"][/dh_carousel_item]
					  ' ) );
vc_map( 
	array( 
		'name' => __( 'Carousel Item', 'luxury-wp' ), 
