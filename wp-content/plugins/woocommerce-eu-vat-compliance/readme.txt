...
This plugin is supported on, and information in this document is for, WooCommerce 2.4 up to 3.2 (releases up to 1.7.1 were also tested on WC 2.0, up to 1.10.26 on WC 2.1, up to 1.11.9 on WC 2.2 and up to 1.11.14 on WC 2.3 - you can still download those versions if you wish). It fetches data on current VAT rates from Amazon S3 (using SSL if possible); or, upon failure to connect to Amazon S3, from https://euvatrates.com. If your server's firewall does not permit this, then it will use static data contained in the plugin.
...
== Upgrade Notice ==
* 1.11.16 : Add access to Czech National Bank official exchange rates
