	...
	public static function process_bundle_data( $product ) {
		...
		if ( $product->is_type( 'bundle' ) ) {
			...
			if ( false === $product->validate_group_mode() ) {
				...
				self::add_admin_error( sprintf( __( 'Invalid <strong>Group mode</strong> selected. %s To configure this bundle as <strong>unassembled</strong>: <ol><li>Under <strong>Product Data</strong>, enable the <strong>Virtual</strong> option.</li><li>Go the the <strong>General</strong> tab and ensure that <strong>Regular Price</strong> and <strong>Sale Price</strong> are empty.</li><li>Go the the <strong>Bundled Products</strong> tab and enable <strong>Shipped Individually</strong> under the <strong>Basic Settings</strong> of each bundled item.</li></ol>', 'woocommerce-product-bundles' ), $group_modes_without_parent_msg ) );
			}
		}
	}
